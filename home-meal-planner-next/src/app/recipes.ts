...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    links: [],
    contents: ['peruna', 'porkkana', 'siskonmakkara', 'palsternakka'],
  ...
  },
  {
    ...
    links: [],
    contents: ['pakastekalaa', 'peruna', 'porkkana', 'punajuuri'],
  ...
  },
  {
    ...
    contents: ['hyvää pastaa', 'feta / tofukuutio', 'chili', 'kirsikkatomaatteja', 'basilika', '(valkosipuli)'],
  ...
  {
    id: 'B2n3M4k6',
    title: 'Gochujang kanakastike',
    links: ['https://www.kariniemen.fi/reseptit/gochujang-kanakastike/'],
    contents: [
      '400 g broilerin hunajafileesuikale',
      '2 dl kookosmaitoa',
      '2 dl kaurakermaa',
    ...
    text: 'Gochujang kanakastike kookosmaidolla.',
  },
  {
    id: 'C6v5B4n3',
    title: 'Kalakeitto',
    links: [],
    contents: ['kalaa', 'perunaa', 'porkkanaa', 'kerma', 'tilli'],
  ...
  },
  {
    ...
    links: [
      'https://www.mtvuutiset.fi/makuja/reseptit/resepti/makujen-aamu-ponzu-marinoitua-broileria-ja-paahdettuja-kasviksia-pellilla/7319510',
    ],
    contents: [
      '500g broilerinfilee',
      'ponzukastiketta',
  ...
  },
  {
    ...
    contents: ['250g broilerin fileesuikale', 'hemapa', 'kanaliemikuutio', 'risottoriisi'],
  ...
  },
  {
    ...
    title: 'Avocadopasta',
    links: [],
    contents: ['chili', 'lime', 'basilika', 'lehtipersilja', 'parmesan 60 g', '400-500g spaghetti'],
  ...
  },
  {
    ...
    contents: ['porkkana 500g', 'palsternakka (1)', 'sipuli', 'kesäkurpitsa 300g', 'yrtti tuorejuustoa'],
  ...
  },
  {
    ...
    links: [],
    contents: ['soijasuikaleet yms.', 'parsakaali', 'porkkana', 'paprika', 'papuja'],
